...
class _Signup(Model):
    ...
    hear_channel_other = Column(UnicodeText, default=u'', nullable=False)
    ...
    unicode_keys = ['subdomain', 'language', 'name', 'surname', 'role', 'phone', 'email', 'secondary_email',
                    ...
                    'hear_channel', 'hear_channel_other',
